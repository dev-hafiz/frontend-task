...
const MeetSlot = () => {
  return (
    <div className="lg:py-10  bg-[#FAF6EF]">
        ...
        <div className="flex gap-10 flex-col-reverse items-center justify-between lg:flex-row">
          <div className="p-4">
            <div className="lg:max-w-xl ">
              <h2 className="font-Georama lg:block hidden text-4xl lg:text-6xl font-medium lg:-mt-0 -mt-52 ">
                Meet <br /> GelatoConnect at <br /> Printing United
              </h2>
              <h2 className="font-Georama text-3xl lg:hidden block font-medium lg:-mt-0 -mt-52 ">
